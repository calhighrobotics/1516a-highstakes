...
public:
    ...
    */
   void AutoDrive(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
...
private:
    ...
    * strategy.
    */
   void Auton1(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
    ...
    * strategy.
    */
   void Auton2(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
    ...
    * @param puncher A reference to the Puncher object.
    */
   void Auton3(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
    ...
    * competition
    */
   void Auton4(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
    ...
    */
   void Auton5(pros::Motor intake_motor, pros::adi::Pneumatics clamp);
};
} // namespace Robot